export default function Card({ imgSrc, title, description, likes }) {
  return (
    <div className="card w-36 h-48 rounded-3xl bg-white border-gray-200 border-solid border-2 relative">
      <div className="card-image rounded-t-3xl w-36 h-22 overflow-hidden">
        <img
          src={imgSrc.src}
